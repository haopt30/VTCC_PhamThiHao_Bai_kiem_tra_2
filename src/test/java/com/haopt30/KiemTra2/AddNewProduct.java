package com.haopt30.KiemTra2;

import com.haopt30.common.BaseTest;
import com.haopt30.helpers.CaptureHelper;
import com.haopt30.utils.LogUtils;
...
public class AddNewProduct extends BaseTest {
    ...
    public void testCreateNewProduct() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//div[@class='dropdown-menu show']//input[@aria-label='Search']")).sendKeys("hao");
        driver.findElement(By.xpath("//a[@id='bs-select-2-84']")).click();
        // Unit
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath("//span[@role='textbox']")).sendKeys("product hao");

        // captureScreenshot

        CaptureHelper.captureScreenshot("captureScreenshot hao test");
